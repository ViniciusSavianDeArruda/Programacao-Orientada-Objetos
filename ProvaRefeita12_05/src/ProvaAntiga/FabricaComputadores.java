...
public class FabricaComputadores {
	...
	static abstract class Computador {
		...
		public Computador(String modelo, String numeroSerie, double custoBase) throws ViolacaoOrcamentariaException {

			if (custoBase < 0) {
				throw new ViolacaoOrcamentariaException("Erro: custo base não pode ser negativo!");
			}

			if (custoBase > LIMITE_MAXIMO) {
				throw new ViolacaoOrcamentariaException("Erro: custo base ultrapassa o limite de R$ " + LIMITE_MAXIMO);
			}
	...
	static class Notebook extends Computador {
		...
		public Notebook(String modelo, String numeroSerie, double custoBase) throws ViolacaoOrcamentariaException {
	...
	static class Desktop extends Computador {
		...
		public Desktop(String modelo, String numeroSerie, double custoBase) throws ViolacaoOrcamentariaException {
			super(modelo, numeroSerie, custoBase);
		}
